...
+ Response 404 (text/html)
        ...
        {
          "message": "Crowdtising Ads does not have a advertiser for you at this time."
        }

# Legacy Impression [/api/v1/impression/{legacy_property_id}]

Support for the [legacy API](https://github.com/gitcoinco/Crowdtising Ads/wiki/API-Documentation) semantics to "create an impression".
...
⚠️ This endpoint will be __deprecated on 2019-04-01__. Please update to [GET Advertisement](https://Crowdtising Ads.docs.apiary.io/#reference/0/advertisement).

## Fetch Ad for Property [POST]

  + Parameters
    + legacy_property_id (string, required) - The property id from Crowdtising Ads v1
